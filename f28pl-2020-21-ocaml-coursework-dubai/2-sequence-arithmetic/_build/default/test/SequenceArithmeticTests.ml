...
let seq_add_test3 _test_ctxt =
  (* TODO *)
  assert_equal [4; 20; 8] (seq_add [2; 10; 5] [2; 10; 3])
(* another test of seq_add on two non-empty lists *)
let seq_add_test4 _test_ctxt =
  (* TODO *)
  assert_equal [6; 9; 4] (seq_add [4; 5; 1] [2; 4; 3])
...
let seq_mult_test2 _test_ctxt =
  (* TODO *)
  assert_equal [30; 16; 10] (seq_mult [6; 2; 1] [5; 8; 10])

(* test seq_mult on two non-empty lists *)
let seq_mult_test3 _test_ctxt =
  (* TODO *)
  assert_equal [16; 42; 24] (seq_mult [4; 6; 8] [4; 7; 3])

(* test seq_mult on two non-empty lists *)
let seq_mult_test4 _test_ctxt =
  (* TODO *)
  assert_equal [36; 49; 64] (seq_mult [6; 7; 8] [6; 7; 8])
